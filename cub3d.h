...
/*   Updated: 2024/01/15 20:23:00 by asettar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			check_textures_colors(char *line, short *flag, t_map *map);
...
uint32_t		get_texture_color(mlx_texture_t *tx, t_ray *r, double w, int y);
mlx_texture_t	*get_correct_texture(t_game *game, t_ray *ray);
void			project_wall(t_game *game, int x, t_ray *ray);
bool			check_horz_intr(double xi, double yi, t_ray *r, t_game *g);
bool			check_vert_intr(double xi, double yi, t_ray *r, t_game *g);
